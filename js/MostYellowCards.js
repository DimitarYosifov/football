...
export default class MostYellowCards extends PIXI.Container {
    constructor(app) {
        super();
        this.app = app;
        this.mostYellowCardsData = this.app.mostYellowCards;
        ...
        console.log(this.allYellowCards);
    ...
    addBackground() {
        this.backgroundImg = new Background(this.app, {
            gamePhase: "mostYelloCards",
            sprite: new GameTexture(this.app, "yellowCardsBG"),
    ...
    addHeader() {
        this.header = new PIXI.Text("YELLOW CARDS", {
    ...
    addPlayers() {
        this.finalData.forEach((el, idx) => {
            ...
            let yellowCards = new PIXI.Text(data.yellowCards, {
                fontFamily: this.app.config.mainFont,
                fontSize: this.app.height / 25,
                fill: '#dbb7b7',
                // align: 'center',
            ...
            yellowCards.position.set(this.app.width * 0.75, y + this.app.height * 0.01);
